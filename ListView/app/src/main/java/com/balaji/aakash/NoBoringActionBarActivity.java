    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				public void onItemClick(AdapterView<?> parent, View view,
					...
					switch( position )
					{
						case 1:  Intent newActivity = new Intent(NoBoringActionBarActivity.this, First1.class);
							startActivity(newActivity);
							break;
						case 2:  Intent newActivity2 = new Intent(NoBoringActionBarActivity.this, First2.class);
							startActivity(newActivity2);
							break;
						case 3:  Intent newActivity3 = new Intent(NoBoringActionBarActivity.this, First3.class);
							startActivity(newActivity3);
							break;
						case 4:Intent newActivity4 = new Intent(NoBoringActionBarActivity.this, First4.class);
							startActivity(newActivity4);
							break;
						case 5:Intent newActivity5 = new Intent(NoBoringActionBarActivity.this, First5.class);
							startActivity(newActivity5);
							break;
						case 6:Intent newActivity6 = new Intent(NoBoringActionBarActivity.this, First6.class);
							startActivity(newActivity6);
							break;
						case 7:Intent newActivity7 = new Intent(NoBoringActionBarActivity.this, First7.class);
							startActivity(newActivity7);
							break;
						case 8:Intent newActivity8 = new Intent(NoBoringActionBarActivity.this, First8.class);
							startActivity(newActivity8);
							break;
						case 9:Intent newActivity9 = new Intent(NoBoringActionBarActivity.this, First9.class);
        ...
        mHeaderPicture.setResourceIds(R.drawable.historyworld3, R.drawable.historyworld);
