...
public class notboring
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHeaderLogo = (ImageView) findViewById(R.drawable.balaji);
    ...
    private void setupListView() {
		...
		mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				public void onItemClick(AdapterView<?> parent, View view,
					...
					switch( position )
					{
						case 0:  Intent newActivity = new Intent(NoBoringActionBarActivity.this, Eighteenth1.class);
							startActivity(newActivity);
							break;
						case 1:  Intent newActivity2 = new Intent(NoBoringActionBarActivity.this, Eighteenth2.class);
							startActivity(newActivity2);
							break;
						case 2:  Intent newActivity3 = new Intent(NoBoringActionBarActivity.this, Eighteenth3.class);
							startActivity(newActivity3);
							break;
						case 3:Intent newActivity4 = new Intent(NoBoringActionBarActivity.this, Eighteenth4.class);
							startActivity(newActivity4);
							break;
						case 4:Intent newActivity5 = new Intent(NoBoringActionBarActivity.this, Eighteenth5.class);
							startActivity(newActivity5);
							break;
						case 5:Intent newActivity6 = new Intent(NoBoringActionBarActivity.this, Eighteenth6.class);
							startActivity(newActivity6);
							break;
						case 6:Intent newActivity7 = new Intent(NoBoringActionBarActivity.this, Eighteenth7.class);
							startActivity(newActivity7);
							break;
						case 7:Intent newActivity8 = new Intent(NoBoringActionBarActivity.this, Eighteenth8.class);
							startActivity(newActivity8);
							break;
						case 8:Intent newActivity9 = new Intent(NoBoringActionBarActivity.this, Eighteenth9.class);
