 ...
 */
public class Fourth8 extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Operation Bluestar was an Indian Army operation to flush out rebels/terrorists/freedom fighters from the Sikhism's holiest shrine in Amritsar. The June 1984 operation is among the most controversial events in modern Indian history. Here is the site of all the action.\n" +
                "\n" +
                "\n" +
