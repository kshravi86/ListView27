...
*/
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        Intent intent = null;
                ...
                switch( position )
                {
                    case 1:  Intent newActivity = new Intent(SeventhActivity.this, Seventh1.class);
                        startActivity(newActivity);
                        break;
                    case 2:  Intent newActivity2 = new Intent(SeventhActivity.this, Seventh2.class);
                        startActivity(newActivity2);
                        break;
                    case 3:  Intent newActivity3 = new Intent(SeventhActivity.this, Seventh3.class);
                        startActivity(newActivity3);
                        break;
                    case 4:Intent newActivity4 = new Intent(SeventhActivity.this, Seventh4.class);
                        startActivity(newActivity4);
                        break;
                    case 5:Intent newActivity5 = new Intent(SeventhActivity.this, Seventh5.class);
                        startActivity(newActivity5);
                        break;
                    case 6:Intent newActivity6 = new Intent(SeventhActivity.this, Seventh6.class);
                        startActivity(newActivity6);
                        break;
                    case 7:Intent newActivity7 = new Intent(SeventhActivity.this, Seventh7.class);
                        startActivity(newActivity7);
                        break;
                    case 8:Intent newActivity8 = new Intent(SeventhActivity.this, Seventh8.class);
                        startActivity(newActivity8);
                        break;
                    case 9:Intent newActivity9 = new Intent(SeventhActivity.this, Seventh9.class);
                        startActivity(newActivity9);
                        break;
                    case 10:Intent newActivity10 = new Intent(SeventhActivity.this, Seventh10.class);
                        startActivity(newActivity10);
                        break;
                    case 11:Intent newActivity11 = new Intent(SeventhActivity.this, Seventh11.class);
                        startActivity(newActivity11);
                        break;
                    case 12:Intent newActivity12 = new Intent(SeventhActivity.this, Seventh12.class);
