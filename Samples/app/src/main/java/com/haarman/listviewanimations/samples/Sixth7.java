 ...
 */
public class Sixth7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("On 6th June, 1966 India, hit by drought after two major wars (with China and Pakistan), devalued rupee by a massive rate: from Rs.4.76=$1 to Rs.7.50 = $1 (57% devaluation). Again in July 1991, hit by gulf war and collapse of Soviet Union (India's main trading partner then), India devalued rupee from Rs.18=$1 to Rs.25 to $1. [June is a bad time for Indian rupee]\n" +
                "Historical Exchange Rate Regime of Asian Countries\n" +
                "\n" +
