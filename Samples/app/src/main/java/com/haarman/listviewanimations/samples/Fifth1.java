 ...
 */
public class Fifth1 extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Here is the backdrop. A great warrior who is fighting against injustice is suddenly overcome by sorrow. He had to fight a war against everyone he cared for - his cousins, teacher, uncles, classmates.. Overtaken by emotions, he attempts to give up the war. \n" +
                "\n" +
                ...
                "\n" +
                "Here is the full text to start: Page on Luminist. Here is my attempt at serializing the Gita using the version from Sivananda and adding more historical background. Dharmam\n");
    }
